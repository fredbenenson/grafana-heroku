...
ENV GF_FEATURE_TOGGLES_ENABLE="regressionTransformation"
...
ARG GF_INSTALL_PLUGINS="marcusolsson-dynamictext-panel"
...
COPY docker/heroku-start.sh /

ENTRYPOINT [ "" ]
CMD [ "sh", "/heroku-start.sh" ]
